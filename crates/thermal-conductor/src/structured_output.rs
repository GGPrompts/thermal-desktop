...
//!
//! `AgentEvent` variants are produced by the JSONL tailer (`window/jsonl_tailer.rs`)
//! via `session_log::parse_session_event` and consumed by the overlay widget manager.
