...
fn main() -> anyhow::Result<()> {
    ...
    let pidfile = thermal_core::runtime::pidfile_path("wallpaper");
    thermal_core::runtime::enforce_single_instance_at("thermal-wallpaper", &pidfile);
    let _ = thermal_core::runtime::write_pidfile("thermal-wallpaper", &pidfile);
    ...
    thermal_core::runtime::remove_pidfile("thermal-wallpaper", &pidfile);
